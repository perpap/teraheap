...
TC_MULTI_THREAD = $(TESTDIR)/tc_multi_thread.o
TC_MT_EXTEND_REGIONS = $(TESTDIR)/tc_mt_extend_regions.o
...
TC_MULTI_THREAD_EXE = tc_multi_thread.bin
TC_MT_EXTEND_REGIONS_EXE = tc_mt_extend_regions.bin
...
LDFLAGS = $(AIOFLAG)
CFLAGS = $(BINFLAG) $(WALLFLAG) $(OPTIMIZEFLAG) -std=gnu11
