...
function usage() {
  ...
  echo "   Examples:"
  echo
  echo "  ./build.sh                            Build tera_malloc without debug symbols."
  echo "  ./build.sh -d                         Build tera_malloc with debug symbols."
  echo "  ./build.sh --debug                    Build tera_malloc with debug symbols."
