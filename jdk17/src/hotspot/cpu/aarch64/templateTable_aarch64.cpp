...
#ifdef TERA_FLAG
    if (EnableTeraHeap){
      __ mov(rscratch1, (int32_t)(intptr_t)INIT_TF_HEX);// Load the teraflag value into r1
      __ str(rscratch1, Address(r0, oopDesc::teraflag_offset_in_bytes()));// Store the teraflag in the object header 
    }
#endif //TERA_FLAG
